...
The script uses the Spotipy library / Spotify Web API to copy songs from the Discover Weekly and Release Radar lists and adds them to a seperate playlist.
